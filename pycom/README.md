## The webserver is based on MicroWebSrv

In order to make MicroWebSrv work on WiPy, the library needs to be 
precompiled. This involves compiling your own firmware. Remember to include 
the files `"microWebSrv.py"`, `"microWebSocket.py"` and 
`"microWebTemplate.py"` in the frozen folder prior to compiling the 
firmware. 

There are no changes to the MicroWebSrv. I used commit 73cd549f926d2bd1c9a60e9979a53283d547ee15
for this project. 

All my web-code is included in main.py. 
